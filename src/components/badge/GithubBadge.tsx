export default function GithubBadge({url}: {url:string}) {
    return (
    <a href={url} target="_blank" rel="noreferrer" className="flex px-1 bg-gray-200 rounded-3xl outline items-center gap-1 text-gray-600 transition-colors hover:text-gray-400">
